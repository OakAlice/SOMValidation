# Trial SOM shapes to create an optimal SOM
...
setwd(here()) # set the working directory to our spot
  
# load in the dog data
load("DogTrDat.rda") # trDat

# load in the testing data
load("DogTstDat.rda")

# Run the test 10 times and select the optimal shape
optimal_dimensions <- run_som_tests(DogtrDat, DogtstDat)
  
print(paste("width", optimal_dimensions$best_width, "height", optimal_dimensions$best_height), sep = " ")
